...
--> statement-breakpoint
CREATE INDEX `membership_organization_id_idx` ON `membership` (`organization_id`);--> statement-breakpoint
...
CREATE INDEX `subscription_organization_id_idx` ON `subscription` (`organization_id`);--> statement-breakpoint
CREATE TABLE `user` (
	`id` text PRIMARY KEY NOT NULL,
	`name` text NOT NULL,
	`email` text NOT NULL,
